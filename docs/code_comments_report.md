...
| `backend/app/infrastructure/postgres_vector_store.py` | 9 | Ce fichier encapsule le stockage vectoriel PostgreSQL. pgvector est le mode actif; le mode json est disponible uniquement par configuration explicite de developpement local. |
